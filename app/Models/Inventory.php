...
{
  // Tidak perlu mendefinisikan $fillable karena kita menggunakan semua field sesuai tabel
  // Mass assignment protection akan diatur secara otomatis oleh Laravel
