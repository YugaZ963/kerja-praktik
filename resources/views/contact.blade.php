            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-footer">
                        <div class="row">
                            <div class="col-md-8">
                                <h6 class="mb-2"><i class="bi bi-building me-2"></i>{{ $mapsData['storeLocation']['name'] }}</h6>
                                <p class="mb-1"><i class="bi bi-geo-alt me-2"></i>{{ $mapsData['storeLocation']['address'] }}</p>
                                <p class="mb-0"><i class="bi bi-telephone me-2"></i>{{ $mapsData['storeLocation']['phone'] }}</p>
                            </div>
                            <div class="col-md-4 text-end">
                                <a href="{{ $mapsData['simpleDirectionsUrl'] }}" target="_blank" class="btn btn-outline-primary btn-sm">
...
@section('scripts')
            ...
            // Marker untuk toko
             const storeMarker = new google.maps.Marker({
                ...
                icon: {
                     ...
                     `),
                     scaledSize: new google.maps.Size({{ $mapsData['mapSettings']['marker_icon']['width'] }}, {{ $mapsData['mapSettings']['marker_icon']['height'] }})
                 }
            });
    ...
    <script async defer 
             src="https://maps.googleapis.com/maps/api/js?key={{ $mapsData['apiKey'] }}&callback=initMap">
     </script>
@endsection
