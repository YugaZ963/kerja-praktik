                        ...
                        <div class="col-12 mb-4">
                            <div class="alert alert-danger border-danger">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h5 class="alert-heading mb-1">PESANAN TELAH DI BATALKAN !!!</h5>
                                        <p class="mb-0">Pesanan dengan nomor #{{ $order->order_number }} telah dibatalkan.
                                            Jika Anda memiliki pertanyaan, silakan hubungi customer service kami.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="status-timeline">
                                    @if ($order->status === 'cancelled')
                                        {{-- Timeline for cancelled orders - only show 'Pesanan Dibuat' and 'Pesanan Telah Dibatalkan' --}}
                                        <div class="timeline-item active">
                                            ...
                                            <div class="timeline-content">
                                                ...
                                                <p class="timeline-desc">Pesanan berhasil dibuat dan menunggu pembayaran</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="timeline-item active current cancelled">
                                            ...
                                            <div class="timeline-content">
                                                <h6 class="timeline-title">Pesanan Telah Dibatalkan !!!</h6>
                                                <p class="timeline-desc">Pesanan telah dibatalkan dan tidak dapat diproses
                                                    lebih lanjut</p>
                            ...
                            <div class="card-body">
                                <div class="payment-info">
                                    <div class="payment-method">
                                        <i
                                            class="fas fa-{{ $order->payment_method === 'bri' ? 'university' : 'wallet' }} me-2"></i>
                                ...
                                <div class="action-buttons">
                                    ...
                                    @if ($order->status === 'delivered')
                                        <button type="button" class="btn btn-warning w-100 mb-3" data-bs-toggle="modal"
                                            ...
                                            Upload Foto Barang Sudah Sampai
                                        </button>
                                        <form action="{{ route('customer.orders.mark-completed', $order) }}" method="POST" class="mb-3">
                                            @csrf
        ...
        <div class="modal fade" id="paymentModal" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{ route('customer.orders.upload-payment', $order) }}" method="POST"
        ...
        <div class="modal fade" id="deliveredModal" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{ route('customer.orders.upload-delivery', $order) }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
                            <div class="delivery-info-modal mb-4">
...
@push('styles')
    <style>
        ...
        .timeline-item.current.cancelled .timeline-marker {
            background: var(--danger-color);
            box-shadow: 0 0 0 4px rgba(202, 32, 104, 0.2);
            animation: pulse 2s infinite;
        }

        .timeline-item.current.cancelled .timeline-title {
            color: var(--danger-color);
            font-weight: 700;
            font-size: 1.1rem;
        }

        .timeline-item.current.cancelled .timeline-desc {
            color: var(--danger-color);
            font-weight: 600;
        }
